...
Every scan is always traced to ``~/.local/share/secscan/scan.log`` regardless of
...
LOGGER_NAME = "secscan"
DEFAULT_LOG_FILE = os.path.expanduser("~/.local/share/secscan/scan.log")
...
def setup_logging(
    *,
    ...
    """Configure the ``secscan`` logger once. Idempotent: later calls return the
...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    """Return the shared logger, or a named child (``secscan.<name>``)."""
